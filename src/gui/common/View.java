...
public abstract class View extends JPanel
	...
	public static final Color TableColumnHeaderColor = new Color(
			153, 204, 255);
	 ...
	 *            size.}
	 */
	public static Font createFont(Font prototype,
			int size) {
		return new Font(prototype.getName(),
				prototype.getStyle(), size);
	}
	...
	public static TitledBorder createTitledBorder(
			String borderTitle, int size) {
		TitledBorder border = BorderFactory
				.createTitledBorder(borderTitle);
		border.setTitleFont(createFont(UIManager
