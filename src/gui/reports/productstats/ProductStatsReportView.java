...
public class ProductStatsReportView extends
		DialogView implements
	...
	public ProductStatsReportView(GUI parent,
			DialogBox dialog) {
		super(parent, dialog);

		construct();

		this._controller = new ProductStatsReportController(
				this);
	}

	@Override
	public IProductStatsReportController getController() {
		return (IProductStatsReportController) super
				.getController();
	}
				...
				new ButtonBankListener() {
					...
					public void buttonPressed(
						...
						switch (index) {
							case 0:
								ok();
								ProductStatsReportView.this._dialog
										.dispose();
								break;
							case 1:
								cancel();
