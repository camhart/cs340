...
public class NoticesReportView extends DialogView
		implements INoticesReportView {
	...
	public NoticesReportView(GUI parent,
			DialogBox dialog) {
		super(parent, dialog);

		construct();

		this._controller = new NoticesReportController(
				this);
	}

	@Override
	public INoticesReportController getController() {
		return (INoticesReportController) super
				.getController();
	}
				...
				new ButtonBankListener() {
					...
					public void buttonPressed(
						...
						switch (index) {
							case 0:
								ok();
								NoticesReportView.this._dialog
										.dispose();
								break;
							case 1:
								cancel();
