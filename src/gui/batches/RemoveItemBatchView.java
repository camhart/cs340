...
public class RemoveItemBatchView extends
		ItemBatchView implements
		IRemoveItemBatchView {

	public RemoveItemBatchView(GUI parent,
			DialogBox dialog) {
		super(parent, dialog);

		construct();

		this._controller = new RemoveItemBatchController(
				this);
	}
	...
	public IRemoveItemBatchController getController() {
		return (IRemoveItemBatchController) super
				.getController();
	}
