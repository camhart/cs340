...
public class TransferItemBatchView extends
	...
	public TransferItemBatchView(GUI parent,
			DialogBox dialog,
		...
		this._controller = new TransferItemBatchController(
				this, target);
	}
	...
	public ITransferItemBatchController getController() {
		return (ITransferItemBatchController) super
				.getController();
	}
